...
public:
	...
	{
		double si_1 = generator.prior_distribution(Distribution::TYPE_DISTR::NORM_WITH_PARAM, 0.5, 1), si_2 = generator.prior_distribution(NORM_WITH_PARAM, 0.5, 1), b = generator.prior_distribution(NORM_WITH_PARAM, 0.001, 0.001);
